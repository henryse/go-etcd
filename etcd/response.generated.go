	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF81978, `StatusCode`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeInt(int64(x.StatusCode))
			...
			if yyr2 || yy2arr2 {
				...
				if x.Body == nil {
					...
					if false {
						...
						r.EncodeStringBytes(codecSelferCcRAW1978, []byte(x.Body))
					}
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF81978, `Body`)
				r.WriteMapElemValue()
				if x.Body == nil {
					r.EncodeNil()
				} else {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF81978, `Header`)
				r.WriteMapElemValue()
				if x.Header == nil {
					r.EncodeNil()
				} else {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF81978, string(x.Action))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF81978, `action`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF81978, string(x.Action))
		...
		LABEL6:
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF81978, `node`)
				r.WriteMapElemValue()
				if yyn6 {
					r.EncodeNil()
				} else {
		...
		LABEL9:
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					r.WriteMapElemKey()
					r.EncodeString(codecSelferCcUTF81978, `prevNode`)
					r.WriteMapElemValue()
					if yyn9 {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF81978, `etcdIndex`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeUint(uint64(x.EtcdIndex))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF81978, `raftIndex`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeUint(uint64(x.RaftIndex))
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF81978, `raftTerm`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeUint(uint64(x.RaftTerm))
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferCcUTF81978, string(x.Key))
				}
			} else {
				r.WriteMapElemKey()
				r.EncodeString(codecSelferCcUTF81978, `key`)
				r.WriteMapElemValue()
				if false {
				} else {
					r.EncodeString(codecSelferCcUTF81978, string(x.Key))
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					if false {
						...
						r.EncodeString(codecSelferCcUTF81978, string(x.Value))
					}
				} else {
					r.EncodeString(codecSelferCcUTF81978, "")
				}
			} else {
				if yyq2[1] {
					r.WriteMapElemKey()
					r.EncodeString(codecSelferCcUTF81978, `value`)
					r.WriteMapElemValue()
					if false {
					} else {
						r.EncodeString(codecSelferCcUTF81978, string(x.Value))
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					r.WriteMapElemKey()
					r.EncodeString(codecSelferCcUTF81978, `dir`)
					r.WriteMapElemValue()
					if false {
					} else {
						r.EncodeBool(bool(x.Dir))
		...
		LABEL12:
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					r.WriteMapElemKey()
					r.EncodeString(codecSelferCcUTF81978, `expiration`)
					r.WriteMapElemValue()
					if yyn12 {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					r.WriteMapElemKey()
					r.EncodeString(codecSelferCcUTF81978, `ttl`)
					r.WriteMapElemValue()
					if false {
					} else {
						r.EncodeInt(int64(x.TTL))
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[5] {
					r.WriteMapElemKey()
					r.EncodeString(codecSelferCcUTF81978, `nodes`)
					r.WriteMapElemValue()
					if x.Nodes == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[6] {
					r.WriteMapElemKey()
					r.EncodeString(codecSelferCcUTF81978, `modifiedIndex`)
					r.WriteMapElemValue()
					if false {
					} else {
						r.EncodeUint(uint64(x.ModifiedIndex))
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[7] {
					r.WriteMapElemKey()
					r.EncodeString(codecSelferCcUTF81978, `createdIndex`)
					r.WriteMapElemValue()
					if false {
					} else {
						r.EncodeUint(uint64(x.CreatedIndex))
...
func (x codecSelfer1978) enchttp_Header(v pkg1_http.Header, e *codec1978.Encoder) {
	...
	for yyk1, yyv1 := range v {
		...
		if false {
			...
			r.EncodeString(codecSelferCcUTF81978, string(yyk1))
		}
		r.WriteMapElemValue()
		if yyv1 == nil {
			r.EncodeNil()
...
func (x codecSelfer1978) encSlicestring(v []string, e *codec1978.Encoder) {
	...
	for _, yyv1 := range v {
		...
		if false {
			...
			r.EncodeString(codecSelferCcUTF81978, string(yyv1))
		}
	}
	r.WriteArrayEnd()
}
